...
if (Config.WORKTYPE == 'private') {
        ...
        Asena.addCommand({ pattern: 'tlogo ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        ...
        Asena.addCommand({ pattern: 'tlogo ?(.*)', fromMe: false,dontAddCommandList: true }, (async (message, match) => {
